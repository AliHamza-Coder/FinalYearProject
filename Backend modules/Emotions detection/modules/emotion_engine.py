...
def initialize_emotion_detector(model_name='enet_b0_8_best_vgaf', device=None):
    """
...
def detect_emotion(fer, face_image):
    """
    Predicts emotion for a given face crop using the provided recognizer.
    ...
    emotion, scores = fer.predict_emotions(face_image, logits=False)
